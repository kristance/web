...
<!-- favicon : 웹 브라우저의 title에 표시되는 웹사이트를 대표하는 이미지이다. -->
...
//	C:\Users\tj\Desktop\web\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\k20231226_1_onlinePoll\ 
//	out.println(application.getRealPath("/") + "poll.txt");
// C:\Users\tj\Desktop\web\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\k20231226_1_onlinePoll\poll.txt
...
%>
	...
	cellpadding : 셀 안 여백, 셀을 구성하는 선과 셀 내부 텍스트와의 간격
 -->
		<table border="1" width="500" align="center" cellspacing="0" cellpadding="5"> <!-- 표 -->
			<tr> <!-- 줄  -->
				<th> <!-- 칸, 표의 첫 줄 또는 첫 열을 구성하는 칸, 굵게 및 가운데 정렬되어 표시된다.  -->
