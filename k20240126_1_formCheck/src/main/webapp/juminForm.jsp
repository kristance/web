...
<!-- 
	...
	form check를 할 때 submit 버튼이 클릭되면 실행되는 onsubmit 이벤트에서 javascript 함수를 실행해서
	form에 입력된 데이터가 정상적인 데이터인가 유효성을 검사해서 검사 결과가 정상이면 true,
	오류가 발생되면 false를 리턴하게 만든다. -> 기본값은 true이다. 
	onsubmit="return javascript함수(this)" 형태로 코딩한다.
 -->
